...
const FilteredList = ({searchString, list}) => {
  ...
  for (let i = 0; i < filteredList.length; i++) {
    rows.push(createData(filteredList[i].name, filteredList[i].status, filteredList[i].gender, filteredList[i].episode.length));
  }
